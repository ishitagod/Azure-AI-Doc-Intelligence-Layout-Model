...
from std_queries import STANDARD_QUERIES # dictionary of standard queries, modify format as per your use case
...
if not HUGGINGFACEHUB_API:
    raise ValueError("HUGGINGFACEHUB_API environment variable not found. Please set it in your .env file.")
...
#Embedding model and vectorize JSON chunks 
...
#Prompt builder with RAG retrieval, modify for your use case
